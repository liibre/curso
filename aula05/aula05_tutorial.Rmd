...
Começamos com salvando os cinco arquivos dentro do diretório `data`. Você deve terminar com a seguinte estrutura:
...
Ao terminar, você deve adicionar ao git todos os arquivos .csv usados neste script, o script em si (`R/01_manipulacao_de_dados.R`) e o dado combinado que foi exportado ao final (`data/01_data_format_combined.csv`). Faça o commit e o push para o repositório remoto. Dia que acaba com um commit é um bom dia!
